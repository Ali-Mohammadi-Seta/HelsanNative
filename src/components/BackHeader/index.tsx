// src/components/BackHeader/index.tsx
    ...
    >
      <View className="flex-row items-center justify-between px-4 py-3 min-h-[56px]">
        ...
        <View className="flex-1">
          {showBackButton && (
            ...
            >
              ...
              />
              <Text className={`text-base font-sans ml-1 mr-1 ${isDark ? 'text-white' : 'text-black'}`}>
                {t('return')}
              </Text>
            </TouchableOpacity>
          )}
        ...
        <View className="flex-[2] items-center justify-center">
          {title && (
            <Text
              className={`text-lg font-bold text-center ${isDark ? 'text-white' : 'text-black'}`}
              numberOfLines={1}
            >
              {title}
            </Text>
        ...
        {/* END SECTION - Right Element or Empty */}
